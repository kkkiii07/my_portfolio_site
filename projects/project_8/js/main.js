...
$(function () {
  // .scrollin-wrapper と .scrollin-wrapper02 を対象に
  $('.scrollin-wrapper, .scrollin-wrapper02').each(function () {
      let cumulativeDelay = 0;

      // ラッパーごとに遅延の基本値を決定
      const isFast = $(this).hasClass('scrollin-wrapper02');
      const delay = isFast ? 60 : 110; // 速くしたい場合はここを小さく
      ...
      $lines.each(function () {
          ...
          cumulativeDelay += str.length * delay + 110;
          $this.html(html);
      });
  });
});
